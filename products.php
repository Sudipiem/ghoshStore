...
<html>
    ...
    <body>
        <div>
            ...
            <div class="container">
                <div class="jumbotron">
                    <h1>Welcome to our GhoshStore</h1>
                    <p>We have the best branded Shirts,Jeans,Sarees for you. No need to go here & there, we have all in one place.</p>
                </div>
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/men fitted Kurta.webp" alt="men fitted Kurta">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>men fitted Kurta</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/men Cotton Crew Neck Sweatshirt.webp" alt="men Cotton Crew Neck Sweatshirt">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Men Cotton Crew Neck Sweatshirt</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/World-X keep Walking Men's Slim Shirt.webp" alt="World-X keep Walking Men's Slim Shirt">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>World-X keep Walking Men's Slim Shirt</h3>
                                    <p>Price: Rs. 899.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/Men's Slim Casual Shirt.webp" alt="Men's Slim Casual Shirt">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Men's Slim Casual Shirt</h3>
                                    <p>Price: Rs. 999.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/Men Stretchable Jeans.webp" alt="Men Stretchable Jeans">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Men Stretchable Jeans</h3>
                                    <p>Price: Rs. 1500.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            ...
                            <center>
                                <div class="caption">
                                    <h3>Men Regular Fit Denim Jeans</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/Men Black Cotton Lycra Regular Fit.webp" alt="Men Black Cotton Lycra Regular Fit">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Men Black Cotton Lycra Regular Fit</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/Men Blue Cotton Lycra Regular Fit.webp" alt="Men Blue Cotton Lycra Regular Fit">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Men Blue Cotton Lycra Regular Fit</h3>
                                    <p>Price: Rs. 899.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/wmen's True Red Cotton Saree.webp" alt="wmen's True Red Cotton Saree">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>women's True Red Cotton Saree</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/Women's Cotton Printed Saree with Blouse.webp" alt="Women's Cotton Printed Saree with Blouse">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Women's Cotton Printed Saree with Blouse</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            ...
                            <center>
                                <div class="caption">
                                    <h3>Women's Cotton Printed Saree</h3>
                                    <p>Price: Rs. 999.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/Women's Flamingo Pink Cotton Saree with Blouse.webp" alt="Women's Flamingo Pink Cotton Saree with Blouse">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Women's Flamingo Pink Cotton Saree with Blouse</h3>
           ...
           <footer class="footer">
               <div class="container">
               <center>
                   <p>This is GhoshStore. All Rights Reserved. | Contact Us: +91 90000 00000</p>
